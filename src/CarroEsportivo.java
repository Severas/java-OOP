...
public class CarroEsportivo extends Veiculo {
    ...
    public CarroEsportivo() {
        setTamanhoTankCombutivel(80);
        this.freiosABS =  new FreiosABS(2000);
    }
